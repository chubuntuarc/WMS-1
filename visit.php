            ...
            <div class="column">
                <table class="table is-hoverable" id="grid">
                    ...
                    <tbody>
                        ...
                        require("connect.php");
                        $sql = "SELECT * FROM visit v LEFT JOIN clients c ON c.id_client = v.client ORDER BY id_visit DESC";
                        //se envia la consulta
                        $result=$mysqli->query($sql);
                        $rows = $result->num_rows;
                        while($row = mysqli_fetch_assoc($result)){
                            echo '<tr>';
                            echo '<td><a href="visit_detail.php?code='.$row['id_visit'].'">'.$row['id_visit'].'</a></td>';
                            echo '<td>'.$row['name'].'</td>';
                            echo '<td>'.$row['initial_time'].'</td>';
