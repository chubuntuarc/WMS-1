...
require("connect.php");
$sql = "SELECT COUNT(*) as cantidad FROM warehouse WHERE status != 2 AND status != 3";
    ...
    <section class="hero is-info">
        <div class="hero-body">
            <div class="container">
                ...
                <h2 class="subtitle">
                    Inventario completo de almacén. <?php echo $cantidad; ?> BIENES. Incluyendo salidas.
                </h2>
            </div>
        </div>
    </section>
